...
int main() {
    ...
    glm::vec3 lightPosition(1.0f, 8.0f, 0.0f);
...
//    GLuint textureId = glGetUniformLocation(programId, "myTextureSampler");
    ...
    do {
        ...
        for(int i=0; i<objectList.size();++i){
            ...
            objectList[i]->renderShadow(ProjectionMatrix, ViewMatrix, depthBiasMVP, idkID);
        }
    ...
    glDeleteProgram(idkID);
    glDeleteProgram(depthId);
